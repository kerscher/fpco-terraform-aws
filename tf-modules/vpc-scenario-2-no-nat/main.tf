/**
 *## AWS VPC, no NAT variant of Scenario 2:
 *
 * This module creates a VPC with both public and private subnets across one or
 * more availability zones. The public subnets route thru an Internet Gateway,
 * but the private subnets do not have any NAT gateway.
 *
 * Similar to Scenario 2 from AWS docs:
